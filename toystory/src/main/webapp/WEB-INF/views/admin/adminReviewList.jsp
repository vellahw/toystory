				...
				<tbody>
						<c:forEach items="${Rlist}" var="review">
						     <tr>
								...
								<td><fmt:formatDate pattern="yyyy-MM-dd" value="${review.r_regdate}" /></td>

								<td width = "150">
									<c:if test="${review.comment_yn eq 1}">
										<c:out value="Y" />
									</c:if>
									<c:if test="${review.comment_yn ne 1}">
										<c:out value="N" />
									</c:if>
								</td> 
							</tr>
